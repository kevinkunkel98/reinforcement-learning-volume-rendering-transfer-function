...
of truth that will also be served by server.py's /api/commands endpoint for
the in-app help panel. Run this script whenever COMMAND_REFERENCE changes."""
...
def render_commands_markdown() -> str:
    ...
    lines.append(
        "> **Auto-generated -- do not edit by hand.** Source of truth is "
        "`commands.COMMAND_REFERENCE`; run `python -m tools.gen_commands_doc` "
        "after changing it and commit the result."
    )
    lines.append("")
